...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "enable_trade_display_image": True,
    "sim_account_initial_cash": 50_000,
    "sim_account_max_stocks": 5,
    "sim_account_cash_reserve_pct": 0.02,
    "sim_account_stop_loss_pct": 0.05,
    "sim_account_take_profit_pct": 0.08,
    "sim_account_max_hold_days": 15,
    "resume_replay_if_available": False,
    "enable_replay_rule_engine": True,
    "rule_ma_short": 5,
    "rule_ma_mid": 10,
    "rule_ma_long": 20,
    "rule_consolidate_days": 6,
    "rule_consolidate_amplitude_max": 8.0,
    "rule_distance_to_high_max": 2.0,
    "rule_volume_surge_ratio": 1.5,
    "rule_sector_rise_min": 0.5,
    "rule_index_fall_limit": -1.5,
    "rule_first_breakout_lookback": 20,
    "rule_index_symbol": "sh000001",
    "rule_stop_loss_ma": 10,
    "rule_report_dir": "data/replay_rule_reports",
    ...
    "paths": {
        ...
        "simulated_account_file": "data/simulated_account.json",
