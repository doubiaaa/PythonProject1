...
def test_dragon_sections_api_error_note():
    err = "API请求失败（429）：x"
    out = ensure_dragon_report_sections(ensure_summary_line(err))
